<script src="scripts/master/productform.js"></script>
<div class="container">
    <div class="row">
        <div class="col-md-12">
			           		...
			           		<fieldset>
			           			...
			           			<div class="col-md-12">
			           				<div class="col-md-6">
										...
										<div class="form-group">
										  <label class="col-md-5 control-label" for="textinput">Product Description</label>  
										  <div class="col-md-7">
										  	<input id="txtProdDescription" name="prodDescription" type="text" placeholder="" class="form-control input-md" />					 	  
										  </div>
										</div>
										<div class="form-group">
